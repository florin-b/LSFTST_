...
public class MainMenu extends Activity {
	...
	public String[] btnNamesAgents = { "Utilizator", "Creare comanda", "Modificare comanda", "Afisare comanda", "Creare cmd GED", "Comenzi simulate",
			...
			"Retur comenzi", "Obiective", "Vanzari", "Neincasate", "Stocuri", "Preturi", "Stare comenzi", "Realizare target", "NTCF", "Salarizare",
			"Urmarire sablon", "Info client", "Plati CEC", "Clienti inactivi", "Clienti semiactivi", "Adrese clienti", "Info venituri", "Delegatii", "Despre",
			"Iesire" };
	...
	public int[] btnImageAgents = new int[] { R.drawable.id_icon, R.drawable.new_icon, R.drawable.modif_icon, R.drawable.preview_icon,
			...
			R.drawable.target, R.drawable.target, R.drawable.money_gold_48, R.drawable.chart_icon, R.drawable.client_info, R.drawable.payment,
	...
	public String[] btnNamesSD = { "Utilizator", "Creare comanda", "Modificare comanda", "Afisare comanda", "Creare cmd GED", "Cmz.blocate limita credit",
			...
			"Modificare custodie", "Vanzari", "Neincasate", "Stocuri", "Obiective", "Preturi", "Preturi concurenta", "Stare comenzi", "Realizare target",
			"NTCF", "Salarizare", "Articole avarie", "Creare sablon", "Afisare sablon", "Urmarire sablon", "Aprobare comanda", "Comenzi conditionate",
			"Info client", "Plati CEC", "Clienti inactivi", "Clienti semiactivi", "Clienti alocati", "Adrese clienti", "Info venituri", "Delegatii", "Despre",
			"Iesire" };
	...
	public int[] btnImageSD = new int[] { R.drawable.id_icon, R.drawable.new_icon, R.drawable.modif_icon, R.drawable.preview_icon, R.drawable.blue_basket_icon,
			...
			R.drawable.target, R.drawable.target, R.drawable.money_gold_48, R.drawable.reduceri_icon, R.drawable.viewreduceri_icon, R.drawable.colosseum,
	...
	public String[] btnNamesDV = { "Utilizator", "Aprobare comanda", "Comenzi conditionate", "Afisare comanda", "Aprobare CLP", "Afisare CLP",
			...
			"Urmarire sablon", "Info client", "Clienti inactivi", "Clienti semiactivi", "NTCF", "Adrese clienti", "Info venituri", "Delegatii", "Despre",
			"Iesire" };
